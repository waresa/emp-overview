...
<section>
    <div id="container">
        ...
        ?>
                    ...
                    <a href='emp-page.php?user_id=<?php echo $employee['users_id'] ?>'><button type='submit' name='submit' class='edit-button'>View</button></a>
                    <a href='#?user_id=<?php echo $employee['users_id'] ?>'><button type='submit' name='submit' class='edit-button'>Contact</button></a>
        <?php
